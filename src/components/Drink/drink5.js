...
function DrinkBeer5() {
    ...
    const initialCountBeer5 = () => Number (window.localStorage.getItem('countBeer5') || 0)
    ...
    useEffect(() => {
        window.localStorage.setItem('countBeer5', countBeer5)
    }, [countBeer5])

    /** stats for shots */
    const initialCountShots5 = () => Number (window.localStorage.getItem('countShots5') || 0)
    ...
    useEffect(() => {
        window.localStorage.setItem('countShots5', countShots5)
    }, [countShots5])

    /** Stats for Drinks/Wine */
    const initialCountDrinks5 = () => Number (window.localStorage.getItem('countDrinks5') || 0)
    ...
    useEffect(() => {
        window.localStorage.setItem('countDrinks5', countDrinks5)
    }, [countDrinks5])
