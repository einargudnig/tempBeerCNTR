...
function DrinkBeer2() {
    ...
    const initialCountBeer2 = () => Number (window.localStorage.getItem('countBeer2') || 0)
    ...
    useEffect(() => {
        window.localStorage.setItem('countBeer2', countBeer2)
    }, [countBeer2])

    /** stats for shots */
    const initialCountShots2 = () => Number (window.localStorage.getItem('countShots2') || 0)
    ...
    useEffect(() => {
        window.localStorage.setItem('countShots2', countShots2)
    }, [countShots2])

    /** Stats for Drinks/Wine */
    const initialCountDrinks2 = () => Number (window.localStorage.getItem('countDrinks2') || 0)
    ...
    useEffect(() => {
        window.localStorage.setItem('countDrinks2', countDrinks2)
    }, [countDrinks2])
